...
- API: <https://pkg.go.dev/github.com/dangernoodle-io/shesha/host/claudecode/statusline>
- Guide: [statusline guide](https://github.com/dangernoodle-io/shesha/wiki/Host-Claudecode-Statusline)
